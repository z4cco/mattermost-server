...
// GetProfilesNotInChannel provides a mock function with given fields: teamId, channelId, groupConstrained, offset, limit
func (_m *UserStore) GetProfilesNotInChannel(teamId string, channelId string, groupConstrained bool, offset int, limit int) store.StoreChannel {
	ret := _m.Called(teamId, channelId, groupConstrained, offset, limit)

	var r0 store.StoreChannel
	if rf, ok := ret.Get(0).(func(string, string, bool, int, int) store.StoreChannel); ok {
		r0 = rf(teamId, channelId, groupConstrained, offset, limit)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(store.StoreChannel)
		}
...
// GetProfilesNotInTeam provides a mock function with given fields: teamId, groupConstrained, offset, limit
func (_m *UserStore) GetProfilesNotInTeam(teamId string, groupConstrained bool, offset int, limit int) store.StoreChannel {
	ret := _m.Called(teamId, groupConstrained, offset, limit)

	var r0 store.StoreChannel
	if rf, ok := ret.Get(0).(func(string, bool, int, int) store.StoreChannel); ok {
		r0 = rf(teamId, groupConstrained, offset, limit)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(store.StoreChannel)
		}
